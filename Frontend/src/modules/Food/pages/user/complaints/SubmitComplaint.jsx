...
export default function SubmitComplaint() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] pb-24 transition-colors">
      {/* Header */}
      <div className="bg-white dark:bg-[#111111] p-4 flex items-center sticky top-0 z-20 shadow-sm border-b border-transparent dark:border-white/10 transition-colors">
        <button
          type="button"
          onClick={goBack}
      ...
      {/* Order Info */}
      <div className="bg-white dark:bg-[#111111] mx-4 mt-4 p-4 rounded-xl shadow-sm border border-gray-100 dark:border-white/10 transition-colors">
        <div className="flex items-center gap-3 mb-3">
          <div className="w-10 h-10 bg-gray-100 dark:bg-white/10 rounded-lg flex items-center justify-center transition-colors">
      ...
      <form onSubmit={handleSubmit} className="mx-4 mt-4 space-y-4">
        ...
        <div>
          ...
          <select
            ...
            className="w-full px-4 py-3 border border-gray-300 dark:border-white/10 bg-white dark:bg-[#111111] text-gray-900 dark:text-white rounded-lg focus:ring-2 focus:ring-[#EB590E] focus:border-transparent transition-colors"
            required
          >
        ...
        <div>
          ...
          <input
            ...
            className="w-full px-4 py-3 border border-gray-300 dark:border-white/10 bg-white dark:bg-[#111111] text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 rounded-lg focus:ring-2 focus:ring-[#EB590E] focus:border-transparent transition-colors"
            required
            maxLength={200}
          />
        </div>
        ...
        <div>
          ...
          <textarea
            ...
            rows={6}
            className="w-full px-4 py-3 border border-gray-300 dark:border-white/10 bg-white dark:bg-[#111111] text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 rounded-lg focus:ring-2 focus:ring-[#EB590E] focus:border-transparent resize-none transition-colors"
            required
            maxLength={1000}
          />
        ...
        {/* Info Box */}
        <div className="bg-blue-50 dark:bg-[#0f2138] border border-blue-200 dark:border-blue-500/30 rounded-lg p-4 flex gap-3 transition-colors">
        ...
        {/* Submit Button */}
        <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-[#111111] border-t border-gray-200 dark:border-white/10 p-4 z-20 transition-colors">
          <button
            type="submit"
            disabled={submitting}
