      ...
      <div className="mx-auto flex min-h-[calc(100vh-80px)] max-w-md flex-col justify-center">
        <div className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-[0_24px_70px_rgba(15,23,42,0.08)]">
          <div className="mb-6 flex items-center justify-center">
            <div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#00c87e]/10 text-[#00c87e]">
          ...
          <div className="mb-6 text-center">
            <p className="mb-2 text-xs font-semibold uppercase tracking-[0.32em] text-[#00c87e]">
          ...
          <div className="mb-6 rounded-2xl border border-slate-200 bg-slate-50 p-4">
            <div className="flex items-start gap-3">
              <ShieldCheck className="mt-0.5 h-5 w-5 text-[#00c87e]" />
          ...
          <div className="space-y-3">
            <Button
              className="h-12 w-full rounded-xl bg-[#00c87e] text-base font-semibold hover:bg-[#00b06f]"
              onClick={() => {
