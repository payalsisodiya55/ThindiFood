...
export default function TermsAndConditionsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] overflow-x-hidden pb-10">
      {/* Header */}
      <div className="fixed top-0 left-0 right-0 bg-white border-b border-slate-100 px-4 py-3 z-50 flex items-center gap-3">
        <button 
          onClick={goBack}
        ...
        <h1 className="text-lg font-bold text-slate-900 flex-1">Terms & Conditions</h1>
      </div>
