...
const DeliveryApproval = lazy(() => import("@food/pages/admin/restaurant/DeliveryApproval"));
// Food Management
...
const OfferApproval = lazy(() => import("@food/pages/admin/restaurant/OfferApproval"));
const DiningOfferManagement = lazy(() => import("@food/pages/admin/restaurant/DiningOfferManagement"));
...
const RestaurantTermsAndCondition = lazy(() => import("@food/pages/admin/settings/RestaurantTermsAndCondition"));
const RestaurantPrivacyPolicy = lazy(() => import("@food/pages/admin/settings/RestaurantPrivacyPolicy"));
      ...
      <Routes>
        ...
        >
          ...
          <Route path="food/*">
            ...
            <Route path="restaurants/delivery-approval" element={<DeliveryApproval />} />
            ...
            <Route path="dining-offers" element={<DiningOfferManagement />} />
            ...
            <Route path="pages-social-media/restaurant-terms" element={<RestaurantTermsAndCondition />} />
            <Route path="pages-social-media/restaurant-privacy" element={<RestaurantPrivacyPolicy />} />
