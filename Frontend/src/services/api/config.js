...
export const API_ENDPOINTS = {
  ...
  ADMIN: {
    ...
    DINING_TERMS: "/food/admin/pages-social-media/dining_terms",
    DINING_TERMS_PUBLIC: "/food/pages/dining_terms",
    PRIVACY: "/food/admin/pages-social-media/privacy",
    PRIVACY_PUBLIC: "/food/pages/privacy",
    RESTAURANT_TERMS: "/food/admin/pages-social-media/restaurant_terms",
    RESTAURANT_TERMS_PUBLIC: "/food/pages/restaurant_terms",
    RESTAURANT_PRIVACY: "/food/admin/pages-social-media/restaurant_privacy",
    RESTAURANT_PRIVACY_PUBLIC: "/food/pages/restaurant_privacy",
    DELIVERY_TERMS: "/food/admin/pages-social-media/delivery_terms",
    DELIVERY_TERMS_PUBLIC: "/food/pages/delivery_terms",
    DELIVERY_PRIVACY: "/food/admin/pages-social-media/delivery_privacy",
    DELIVERY_PRIVACY_PUBLIC: "/food/pages/delivery_privacy",
    ...
    RESTAURANT_FAQS: "/food/admin/restaurant-faqs",
    RESTAURANT_FAQS_REORDER: "/food/admin/restaurant-faqs/reorder",
    RESTAURANT_FAQS_PUBLIC: "/food/restaurant/rating-faqs",
  },
